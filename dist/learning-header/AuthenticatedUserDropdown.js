...
var AuthenticatedUserDropdown = function AuthenticatedUserDropdown(_ref) {
  ...
  var showNotificationsTray = useSelector(selectShowNotificationTray());
  var notificationStatus = useSelector(selectNotificationStatus());
  ...
  }, intl.formatMessage(messages.help)), showNotificationsTray && /*#__PURE__*/React.createElement(Notifications, null), /*#__PURE__*/React.createElement(Dropdown, {
