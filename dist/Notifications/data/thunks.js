...
var normalizeNotificationCounts = function normalizeNotificationCounts(_ref) {
  var countByAppName = _ref.countByAppName,
    count = _ref.count,
    showNotificationsTray = _ref.showNotificationsTray;
  var appIds = Object.keys(countByAppName);
  var apps = appIds.reduce(function (acc, appId) {
    acc[appId] = [];
    return acc;
  }, {});
  return {
    ...
    apps: apps,
    count: count,
    showNotificationsTray: showNotificationsTray
  };
};
var normalizeNotifications = function normalizeNotifications(data) {
  var newNotificationIds = data.results.map(function (notification) {
    return notification.id.toString();
  });
  var notificationsKeyValuePair = data.results.reduce(function (acc, obj) {
    acc[obj.id] = obj;
    return acc;
  }, {});
  var pagination = {
  ...
  return {
    ...
    notificationsKeyValuePair: notificationsKeyValuePair,
    pagination: pagination
  };
};
export var fetchNotificationList = function fetchNotificationList(_ref2) {
  var appName = _ref2.appName,
    page = _ref2.page;
  return /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dispatch) {
      var data, normalisedData;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return getNotificationsList(appName, page);
          case 4:
            data = _context.sent;
            normalisedData = normalizeNotifications(camelCaseObject(data));
            dispatch(fetchNotificationSuccess(_objectSpread({}, normalisedData)));
            _context.next = 12;
            break;
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            if (getHttpErrorStatus(_context.t0) === 403) {
...
export var fetchAppsNotificationCount = function fetchAppsNotificationCount() {
  return /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(dispatch) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            data = _context2.sent;
            normalisedData = normalizeNotificationCounts(camelCaseObject(data));
            dispatch(fetchNotificationsCountSuccess(_objectSpread({}, normalisedData)));
            _context2.next = 12;
            break;
          case 9:
            _context2.prev = 9;
            _context2.t0 = _context2["catch"](0);
            if (getHttpErrorStatus(_context2.t0) === 403) {
...
export var markAllNotificationsAsRead = function markAllNotificationsAsRead(appName) {
  return /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return markAllNotificationRead(appName);
          case 4:
            data = _context3.sent;
          ...
          case 8:
            ...
            if (getHttpErrorStatus(_context3.t0) === 403) {
...
export var markNotificationsAsRead = function markNotificationsAsRead(notificationId) {
  return /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            if (getHttpErrorStatus(_context4.t0) === 403) {
...
export var markNotificationsAsSeen = function markNotificationsAsSeen(appName) {
  return /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(dispatch) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            dispatch(markNotificationsAsSeenRequest({
              appName: appName
            }));
            _context5.next = 4;
            return markNotificationSeen(appName);
          case 4:
            data = _context5.sent;
          ...
          case 8:
            ...
            if (getHttpErrorStatus(_context5.t0) === 403) {
...
export var resetNotificationState = function resetNotificationState() {
  return /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(dispatch) {
