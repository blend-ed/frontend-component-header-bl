module.exports = {
    localModules: [
      ...
      { moduleName: '@edx/frontend-component-header/dist', dir: '../frontend-component-header-bl', dist: 'src' },
      // This line catches JavaScript imports and points them at that same src directory.
      { moduleName: '@edx/frontend-component-header', dir: '../frontend-component-header-bl', dist: 'src' },
    ],
};